...
#
# final_v1.tcl: Tcl script for re-creating project 'final_v1'
#
# Generated by Vivado on Sat Aug 30 01:12:35 IST 2025
...
#
# 1. This project restoration tcl script (final_v1.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/mnt/761C949F1C945C45/BTP_WORK/SNN/Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/final_v1/final_v1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/final_v1/final_v1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/../Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/final_v1"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/IPfolder/final_IP"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  biswajitks.org:biswajit:final_ip:45.0\
  "
...
\
  ...
  set final_ip_0 [ create_bd_cell -type ip -vlnv biswajitks.org:biswajit:final_ip:45.0 final_ip_0 ]
  ...
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins final_ip_0/s_axis_image_data]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tlast [get_bd_pins axi_dma_0/m_axis_mm2s_tlast] [get_bd_pins final_ip_0/s_axis_image_last]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] [get_bd_pins final_ip_0/s_axis_image_valid]
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins axi_dma_0/s_axis_s2mm_tready] [get_bd_pins final_ip_0/m_axis_image_ready]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins final_ip_0/axi_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins final_ip_0/axi_reset_n]
  connect_bd_net -net ver4_imgIpcode_0_m_axis_image_data [get_bd_pins final_ip_0/m_axis_image_data] [get_bd_pins axi_dma_0/s_axis_s2mm_tdata]
  connect_bd_net -net ver4_imgIpcode_0_m_axis_image_last [get_bd_pins final_ip_0/m_axis_image_last] [get_bd_pins axi_dma_0/s_axis_s2mm_tlast]
  connect_bd_net -net ver4_imgIpcode_0_m_axis_image_valid [get_bd_pins final_ip_0/m_axis_image_valid] [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid]
  connect_bd_net -net ver4_imgIpcode_0_s_axis_image_ready [get_bd_pins final_ip_0/s_axis_image_ready] [get_bd_pins axi_dma_0/m_axis_mm2s_tready]
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/final_v1/final_v1.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
