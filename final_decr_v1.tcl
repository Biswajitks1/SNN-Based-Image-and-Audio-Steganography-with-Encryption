...
#
# final_decr_v1.tcl: Tcl script for re-creating project 'final_decr_v1'
#
# Generated by Vivado on Sat Aug 30 01:10:37 IST 2025
...
#
# 1. This project restoration tcl script (final_decr_v1.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/mnt/761C949F1C945C45/BTP_WORK/SNN/Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/final_decr_v1/final_decr_v1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/final_decr_v1/final_decr_v1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../media/biswajitks/DATA/Xilinx/Vivado/2024.1/Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/IPfolder/final_IP"]"]"\
 "[file normalize "$origin_dir/../../../../../media/biswajitks/DATA/Xilinx/Vivado/2024.1/Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/IPfolder/final_IP_decrypt"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "final_decr_v1"
...
set script_file "final_decr_v1.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/final_decr_v1"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../../home/biswajitks/.Xilinx/Vivado/2024.1/xhub/board_store/xilinx_board_store"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/IPfolder/final_IP"] [file normalize "$origin_dir/../Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/IPfolder/final_IP_decrypt"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  user.org:user:final_ip_decrypt:8.0\
  "
...
\
  ...
  # Create instance: final_ip_decrypt_0, and set properties
  set final_ip_decrypt_0 [ create_bd_cell -type ip -vlnv user.org:user:final_ip_decrypt:8.0 final_ip_decrypt_0 ]
  ...
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins final_ip_decrypt_0/s_axis_image_data]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tlast [get_bd_pins axi_dma_0/m_axis_mm2s_tlast] [get_bd_pins final_ip_decrypt_0/s_axis_image_last]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] [get_bd_pins final_ip_decrypt_0/s_axis_image_valid]
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins axi_dma_0/s_axis_s2mm_tready] [get_bd_pins final_ip_decrypt_0/m_axis_sound_ready]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins final_ip_decrypt_0/axi_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins final_ip_decrypt_0/axi_reset_n]
  connect_bd_net -net ver4_imgIpcode_0_m_axis_image_data [get_bd_pins final_ip_decrypt_0/m_axis_sound_data] [get_bd_pins axi_dma_0/s_axis_s2mm_tdata]
  connect_bd_net -net ver4_imgIpcode_0_m_axis_image_last [get_bd_pins final_ip_decrypt_0/m_axis_sound_last] [get_bd_pins axi_dma_0/s_axis_s2mm_tlast]
  connect_bd_net -net ver4_imgIpcode_0_m_axis_image_valid [get_bd_pins final_ip_decrypt_0/m_axis_sound_valid] [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid]
  connect_bd_net -net ver4_imgIpcode_0_s_axis_image_ready [get_bd_pins final_ip_decrypt_0/s_axis_image_ready] [get_bd_pins axi_dma_0/m_axis_mm2s_tready]
  ...
  assign_bd_address -offset 0x10000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.737743",
   "Default View_TopLeft":"9,-244",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 2200 -y 330 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 2200 -y 350 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 3 -x 1130 -y 200 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -x 1940 -y 380 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 630 -y 390 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 200 -y 410 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -x 1570 -y 160 -defaultsOSRD
preplace inst axi_mem_intercon_1 -pg 1 -lvl 4 -x 1570 -y 380 -defaultsOSRD
preplace inst final_ip_decrypt_0 -pg 1 -lvl 2 -x 630 -y 150 -defaultsOSRD
preplace netloc axi_dma_0_m_axis_mm2s_tdata 1 1 3 420 10 NJ 10 1350
preplace netloc axi_dma_0_m_axis_mm2s_tlast 1 1 3 430 20 NJ 20 1370
preplace netloc axi_dma_0_m_axis_mm2s_tvalid 1 1 3 440 30 NJ 30 1360
preplace netloc axi_dma_0_s_axis_s2mm_tready 1 1 2 440 260 920J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 30 310 400 40 890 360 1420 500 1740 500 2150
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 510 NJ 510 NJ 510 NJ 510 NJ 510 2140
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 3 410 270 870 370 1430
preplace netloc ver4_imgIpcode_0_m_axis_image_data 1 2 1 820 150n
preplace netloc ver4_imgIpcode_0_m_axis_image_last 1 2 1 920 170n
preplace netloc ver4_imgIpcode_0_m_axis_image_valid 1 2 1 830 140n
preplace netloc ver4_imgIpcode_0_s_axis_image_ready 1 2 2 900J 40 1340
preplace netloc axi_dma_0_M_AXI_MM2S 1 3 1 N 100
preplace netloc axi_dma_0_M_AXI_S2MM 1 3 1 1380 120n
preplace netloc axi_mem_intercon_1_M00_AXI 1 4 1 N 380
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1710 160n
preplace netloc processing_system7_0_DDR 1 5 1 NJ 330
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ 350
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 440 520 NJ 520 NJ 520 NJ 520 2160
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 910 110n
levelinfo -pg 1 0 200 630 1130 1570 1940 2200
pagesize -pg 1 -db -bbox -sgen 0 0 2320 540
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../Host_Codes/Hardware/gitrepos/myrepos/BTP_SNN/final_decr_v1/final_decr_v1.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
